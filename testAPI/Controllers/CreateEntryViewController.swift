...
final class CreateEntryViewController: UIViewController, UITextViewDelegate {
    ...
    fileprivate var networkDataFetcher : NetworkDataFetcher? = NetworkDataFetcher()
    ...
    private func createEntry<T>(session: T, body : T){
    ...
    @IBAction private func saveEntry(_ sender: UIButton) {
    ...
    @IBAction private func closeEntry(_ sender: UIButton) {
